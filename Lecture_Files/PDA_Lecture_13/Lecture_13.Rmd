...
Typically, for each of the independent variables, the following three plots are drawn to visualize the behavior:
...
3. _Density plot_: To help us see the distribution of the predictor variable. 
...
```{r eval=FALSE, message=FALSE, warning=FALSE, echo=TRUE, na.rm=FALSE}
  ...
  ggplot(mysample, aes(LDLESTIMATE, CHOLESTEROLTOTAL)) + geom_point()
```
