...
We suddenly note that there are two different clusters of patients - one with low UACR values and another with high UACR values, both corresponding to a mean $log(A1c)$ of about $1.7$.
...
To do good data science, it certainly not only helps to know correlations between the variables (in the above figure, we know blood glucose levels and plasma glucose levels correlate), but how we present data matters!
