...
```{r eval=TRUE}
  ...
  library(RCurl)
  # Import the HANES data set
  URL <- "https://raw.githubusercontent.com/kannan-kasthuri/kannan-kasthuri.github.io/master/Datasets/HANES/NYC_HANES_DIAB.csv"
  HANES <- read.csv(text=getURL(URL))
  # Observe the structure
  str(HANES)
  # Note that GENDER and AGEGROUP are integers but they should be factors
