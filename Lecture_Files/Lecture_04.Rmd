...
<br>
<span style="color:blue">**Classwork/Homework**</span>: Evaluate the above code with the else statement printing "x is positive or zero", when it is.
...
**Note**: Never ever change directories in R Markdown documents - just don't do it. You need to put all images inside the folder you are working on to include in the R Markdown document. Include an image of your choice in the submission.
...
2. How do you include images in R Markdown?
