...
Arrays are fixed size seqence of elements, stored contigously whereas linked lists are variable-size sequence of elements which may be heterogenous.
...
Array Lists give you the benefits of arrays, but dynamically allocate resources for you so that you don't need to worry too much about list size and you can delete items at any index without any effort or re-shuffling elements around. Performance-wise, arraylists are slower than raw arrays.
