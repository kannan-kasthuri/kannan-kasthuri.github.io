...
For a given, $n$, these functions, $W(n)$ and $B(n)$, will give us the number of instructions in the extreme cases, and gives an idea on how fast an algorithm can be as $n$ increases.
