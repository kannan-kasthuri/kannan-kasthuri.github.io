...
We will work with HANES data set. In the spirit of in the data transformation section in R for Data Science, we will look into the `dplyr()` functions. As usual, we will first import the curated HANES data set in RStudio:
