...
time difference can be little painful to work with when we are interested in durations. The library lubridate provides an alternative which always uses seconds: the **duration**. 
...
<br>
<span style="color:blue">**Classwork/Homework**</span>: Read section 12.6 in the book. It contains a case study on World Health Organization Global Tuberculosis Report conducted in 2014.
