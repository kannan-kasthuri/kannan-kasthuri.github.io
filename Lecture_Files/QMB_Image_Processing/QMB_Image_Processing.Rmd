...
Sampling is the process of measuring the brightness information only at a discrete number of locations. The sampling process can be modeled in a 2-step scheme:
