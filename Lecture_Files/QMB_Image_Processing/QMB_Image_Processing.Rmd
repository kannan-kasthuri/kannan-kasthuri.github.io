...
But, in general, estimating the noise terms $\eta(x,y)$ is unreasonable, so subtracting them from $g(x,y)$ is impossible. _Spatial filtering_ is the method of choice in situations when only additive noise is present.
