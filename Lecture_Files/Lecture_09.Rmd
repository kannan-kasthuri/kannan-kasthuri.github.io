...
This we need to separate them. But first since each of these variables contains count of new cases, a natural way to organize them would be to gather these variables. We can make a meta-variable "group" and "case-count" to reflect this gathering removing `NA`:
