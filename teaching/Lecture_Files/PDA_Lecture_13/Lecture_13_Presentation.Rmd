...
The null hypothesis, $H_{0}$, here is that the data is drawn from a normal distribution. So a low p-value would mean we need to reject $H_{0}$. 
...
The null hypothesis here is that two variables are drawn from the same distribution.
