...
Inflammatory areas in cells can be identified through H&E staining, and spatial analysis can identify if there is clustering that happens in those areas. The following H&E shows [[1]](#references-and-credits) non-inflammatory (left) and inflammatory (right) regions on a diaphragm section of an MDX mouse. 

<div style="text-align:center" markdown="1">

![H&E identifying inflammation in a diaphragm section of an MDX mouse](HE01.png){width=100%}
...
Epithelial to Messenchymal Transition (EMT) is an important phenomena by which epithelial cells lose their cell polarity and adhesion, to gain migratory and invasive properties and become mesenchymal stem cells. The dual H&E staining below shows TTF1, the nuclear marker for epithelial cells (red), and Vimentin, the messenchymal marker (yellow) in a mouse lung tissue, resurrected from central (above) and peripheral regions (below).

<div style="text-align:center" markdown="1">

![H&E dual staining, Mouse Lung, Central (top) and Peripheral (bottom)](HE02.jpg){width=100%}
...
Several studies have revealed elevated CD8 positive T cells in the tumor micro-environment as an indicator of good prognosis in cancers. A recent <a href="https://jitc.biomedcentral.com/articles/10.1186/s40425-019-0797-4" target="_blank"> study </a> has shown the density and spatial tissue distribution of CD8+ immune cells predict response and outcome in melanoma patients who receive MAPK inhibitors. The following figure shows chromogenic IHC staining of a melanoma tissue for CD8 marker. 

<div style="text-align:center" markdown="1">

![IHC identifying CD8 positive cells in melenoma tissue](CD8WT.jpg){width=100%}
...
Both tumor and stroma can be stained for markers in IHC which can be useful for identifying antibodies specific to these tissue types. Here is an example of identifying CD8 positive cells (red) in both tumor and stroma in a lung tissue biopsy.

<div style="text-align:center" markdown="1">

![IHC identifying CD8 positive cells in tumor and stroma in a lung cancer tissue](CD8TumorStroma.jpg){width=100%}
...
1. H&E staining of diaphragm section of an MDX mouse:
http://www.agadabio.com/services/inflammation-hematoxylin-and-eosin/

2. Janis M. Taube, Geoffrey D. Young, Tracee L. McMiller, Shuming Chen, January T. Salas, Theresa S. Pritchard, Haiying Xu, Alan K. Meeker, Jinshui Fan, Chris Cheadle, Alan E. Berger, Drew M. Pardoll and Suzanne L. Topalian. Differential Expression of Immune-Regulatory Genes Associated with PD-L1 Display in Melanoma: Implications for PD-1 Pathway Blockade. _Clin. Cancer Res._ 21(17); 3969-76. [[Link to the article]](https://clincancerres.aacrjournals.org/content/21/17/3969)

3. We acknowledge and thank the following faculty and members for providing the images and the data:
