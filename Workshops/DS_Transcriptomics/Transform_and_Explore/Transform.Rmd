...
# Make our data frame - note - merged data has 52 patients and 6500 genes
df.uniq <- data.frame(matrix(ncol = 6502, nrow = 52))
# The first column are the patient ids
...
df.uniq[,2] <- group[,1]
# The rest of the matrices are expression values
expression <- as.numeric(t(merged.data[c(1:6500),c(2:53)]))
df.uniq[c(1:52),c(3:6500)] <- expression
```
