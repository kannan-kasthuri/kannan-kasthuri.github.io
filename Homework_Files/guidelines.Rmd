...
Make sure you organize your files really well and name appropriately so it is easier for us to grade. Part of the grades will go for your ability to organize the files for easier access and readability. 

---

##### How to submit homework?

* Make sure you have saved the work in your local directory. When you hit the save icon in the RStudio editor, you will see the markdown .Rmd file popping up in the Git panel of RStudio, ready to be committed.

* Click "Knit to HTML" in the RStudio editor to render the associated HTML file. A preview of the HTML file will be popping up. At this point you will see two files, the markdown and the html documents, ready to be committed to Git.

* Commit the work to the Git repository (for eg., from RStudio).

* Push your work into Github.

* Indicate that you have completed your work by creating a new issue in our [discussion page](https://github.com/PDA-NYU-Fall-2017/Discussion/issues) with the "latest commit" information for your .Rmd and .html files and submit it. You are done now.
