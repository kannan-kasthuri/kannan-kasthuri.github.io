...
2. Click "Knit to HTML" in the RStudio editor to render the associated HTML file. A preview of the HTML file should pop up. At this point you will see two files, the markdown and the html documents, ready to be committed to Git. 
