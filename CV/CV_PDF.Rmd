...
2. Pravesh Gupta, Exploiting microglial neuroimmune axis for monocyte driven glioblastoma immunotherapy. NIH Pathway to Independence.

3. Krishna Bhat, Immune Correlates of AXL Inhibitor (Bemcentinib) Treatment for Brain Tumor Therapy. DoD Peer Reviewed, Translational Team Science Award.

4. Krishna Bhat, Elucidating the Antigen-Presenting Immunomodulatory Axis in Gliomas, NIH R01.

5. Krishna Bhat, Evaluation of immunomodulatory effects of an AXL Inhibitor (Bemcentinib) in glioblastomas. NIH Research Project Grant.

6. Ignacio Wistuba, MD Anderson Cancer Immune Monitoring and Analysis Center MDA-CIMAC, NIH Cancer Immune Monitoring and Analysis Centers (CIMACs) and Cancer Immunologic Data Center (CIDC).
