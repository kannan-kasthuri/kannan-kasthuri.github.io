...
\end{center}
TRB 745, 227 E30th St. New York. NY 10016 \hfill kasthuri.kannan@nyumc.org
...
\textbf{\textcolor{purple}{Data Science Collaborations (representative)}}
...
\textbf{\textcolor{purple}{Skills \& Education Summary}}

```{r echo=FALSE, warning=FALSE}
library(kableExtra)
# Make a data frame for the positions
skills <- data.frame("Proficiency" = c("Data science, Machine Learning","NGS analysis, Image processing","Mathematical Modeling, Statistics","Algorithms, Programming"), "Software" = c("Python, R, Scripts(Perl/Bash), C++, spatstat","Matlab, Samtools, GATK, Bioinformatics Tools","MySQL, PostgreSQL, MS Access","Unix, Linux variants, Windows (all versions)"))
```
...
\textbf{Assistant Professor (Pathology)} \hfill \textbf{Dec 2013} - \textbf{Present} \linebreak
...
\textbf{\textcolor{purple}{Teaching Initiatives (Course Director)}}
