...
2. w/ Swaminathan Iyer, Characterize and modulate the immune microenvironment in T-cell neoplasms. Cancer Moonshot, UT MD Anderson Cancer Center (awarded).

3. w/ Ignacio Wistuba, MD Anderson Cancer Immune Monitoring and Analysis Center MDA-CIMAC, NIH Cancer Immune Monitoring and Analysis Centers (CIMACs) and Cancer Immunologic Data Center (CIDC) (awarded).
...
\textbf{\textcolor{purple}{Manuscripts in-review \textcolor{blue}{(blue - equal contribution/senior/corresponding/first author)}}}

[33] Prahlad Bhat, Michael Hwang, Afrooz Jahedi, Kanishka Sircar, and \textbf{\textcolor{blue} {Kasthuri Kannan}}. Spatial Point Process Model Predicts Survival in Clear Cell Renal Cell Carcinoma. \textbf{\textit{\textcolor{violet}{medRXiv}}} (doi: https://doi.org/10.1101/2022.02.16.22271019).

\textbf{\textcolor{purple}{Publications/Preprints \textcolor{blue}{(blue - equal contribution/senior/corresponding/first author)}}}

[32] Gayatri Kumar, Renganayaki Krishna Pandurengan, Edwin Roger Parra, \textbf{\textcolor{blue} {Kasthuri Kannan}} and Cara Haymaker, Spatial modelling of the tumor microenvironment from multiplex immunofluorescence images: methods and applications. \textbf{\textit{\textcolor{violet}{Frontiers in Immunology (accepted)}}}.
