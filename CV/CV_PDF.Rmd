...
\end{center}
TRB 737, 550 First Ave. New York. NY 10016 \hfill kasthuri.kannan@nyumc.org

\textbf{\textcolor{black}{Professional Interests}}

Genomics/epigenomics (especially cancer), Mathematical modeling, Teaching (Data science)

\textbf{\textcolor{black}{Successful Collaborations (representative \& recent)}}

\begin{flushleft}

1. Adriana Heguy, PhD, Assistant Dean, Division of Advanced Research Technologies, NYU. \linebreak
\hangindent=0.4cm Why do mutant allele frequencies in oncogenes peak around .40 and rapidly decrease? \textit{Letters in Biomathematics}. Sept. 2016. 

2. Jason Huse, MD, PhD, Associate Professor \& Director, MD Anderson Cancer Center. \linebreak
Atrx inactivation drives disease-defining phenotypes in glioma cells of origin through global epigenomic remodeling. \textit{Nature Communications}. Mar. 2018.

3. Matthias Karajannis, MD, MS, Chief, Pediatric Neuro-Oncology, MSKCC. \linebreak
Recurrent homozygous deletion of DROSHA and microduplication of PDE4DIP containing the ancestral DUF1220 domain in pineoblastoma. \textit{Nature Communications} (accepted, to appear).
...
\textbf{\textcolor{black}{Emerging Collaborations}}

\begin{flushleft}

1. Dean Felsher, MD, PhD, Professor \& Director, Stanford University. \linebreak
\hangindent=0.4cm MYC liver cancer project.

2. Rama Natarajan, PhD, Professor and Chair, Dept. of Diabetes Complications, City of Hope. LA. \linebreak
Epigenomics of diabetes
...
\textbf{\textcolor{black}{Invited Talks}}
...
\textbf{\textcolor{black}{Teaching Responsibilities}}

Course director for the following graduate (MS Biomedical Informatics) courses:
...
\textbf{\textcolor{black}{Employment History}}

\begin{flushleft}
Assistant Professor (Pathology) \hfill Dec 2013 - \linebreak
...
\begin{flushleft}
Research Associate/Fellow	\hfill Apr 2011 – Nov 2013 \linebreak
...
\begin{flushleft}
Research Associate \hfill Oct 2010 – Apr 2011 \linebreak
...
\begin{flushleft}
Research Specialist \hfill Jan 2008 – Sep 2010 \linebreak
...
b. Implemented an automated data workflow to study the growth phases of budding S. Cerevisiae cells.
c. Designed image processing algorithms and software’s for tracking C. Elegans and Drosophila to:
    + study the foraging behavior of C. Elegans [please see PLoS Genet. publication].
    + analyze the mating behavior of Drosophila [please see Cell publication].
...
\begin{flushleft}
Research Intern \hfill Jan 2007 – Dec 2007 \linebreak
...
\textbf{\textcolor{black}{References will be provided upon request}}
