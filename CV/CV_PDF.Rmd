...
\end{flushleft}
Responsibilities include assisting faculty in integrating data science into curricula, developing faculty skills through targeted training, and enhancing student data literacy to support senior-level decision-making, while serving as an expert in data analytics, AI, and business intelligence
