...
\hangindent=0.4cm Patterns of oncogene co-expression at single cell resolution in cancer influence survival. \textit{Cancer Discovery, (accepted)}.
...
\textbf{\textcolor{purple}{Grants (Co-investigator) Awarded/Pending}}

\begin{flushleft}

1. Clinton Yam, The microbiota-immune axis and response to neoadjuvant chemo(immuno)therapy in triple-negative breast cancer. Conquer Cancer Foundation. \# AWD00005359

2. Swaminathan Iyer, Characterize and modulate the immune microenvironment in T-cell neoplasms. Cancer Moonshot, UT MD Anderson Cancer Center.

3. Pravesh Gupta, Exploiting microglial neuroimmune axis for monocyte driven glioblastoma immunotherapy. NIH Pathway to Independence.

4. Krishna Bhat, Immune Correlates of AXL Inhibitor (Bemcentinib) Treatment for Brain Tumor Therapy. DoD Peer Reviewed, Translational Team Science Award.

5. Krishna Bhat, Elucidating the Antigen-Presenting Immunomodulatory Axis in Gliomas, NIH R01.

6. Krishna Bhat, Evaluation of immunomodulatory effects of an AXL Inhibitor (Bemcentinib) in glioblastomas. NIH Research Project Grant.

7. Ignacio Wistuba, MD Anderson Cancer Immune Monitoring and Analysis Center MDA-CIMAC, NIH Cancer Immune Monitoring and Analysis Centers (CIMACs) and Cancer Immunologic Data Center (CIDC).
...
\textbf{\textcolor{purple}{Manuscripts in-review \textcolor{blue}{(blue - equal contribution/senior/last/first author)}}}
