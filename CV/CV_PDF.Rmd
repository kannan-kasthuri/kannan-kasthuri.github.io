...
Professor of Data Science\linebreak
https://kannan-kasthuri.github.io/ \linebreak
\flushleft{Center for Strategic Leadership}
\hfill{The US Army War College, Carlisle Barracks, PA} 
\vspace{0.5mm}
...
Data Science, AI, Systems Biology, Computational Pathology, Bioinformatics
...
\textbf{\textcolor{purple}{Publications}}

[37] Singh A, Maynard ME, Huang L, Kang AM, Prasad S, **Kasthuri K**, Sedlock A, Maric D, Dash PK, Redell JB, Roysam B. Computational delineation and cellular profiling of murine cortical cell layers using multiplex immunofluorescence imaging. \textbf{\textit{\textcolor{violet}{J Neurosci Methods}}}. July 2026. [PMID: 41871770]

[36] Yang Liu, Jason Huse and \textbf{\textcolor{blue} {Kasthuri Kannan}}. A network-based discovery of prognostic markers in recurrent IDH wild-type gliomas. \textbf{\textit{\textcolor{violet}{Frontiers in Genetics}}}. Nov 2025.

[35] Ruiz-Cordero R, Wang Q, Kumar G, Akgul M, Creighton CJ, Rao P, Tamboli P, Zheng L, Zhao J, Murugan P, Shen S, Brimo F, Ezhilarasan R, Sulman E, Wani K, Lazar AJ, Kim T, Chen K, Bhat KPL, **Kannan K**, Wang J, Karam JA, Sircar K. Genomic and Epigenomic Signatures Can Distinguish Aggressive Chromophobe Renal Cell Carcinoma from Indolent Renal Oncocytic Tumors in Clinical-grade Samples. \textbf{\textit{\textcolor{violet}{Eur Urol Oncol}}}. Nov 2025. [PMID: 41193273] 

[34] Yang Liu, Jason Huse and \textbf{\textcolor{blue} {Kasthuri Kannan}}. Expression graph network framework for biomarker discovery. \textbf{\textit{\textcolor{violet}{Briefings in Bioinformatcics}}}. Aug 2025. [PMID: 41139924]
...
University of Texas Medical Branch, Galveston, Oct. 07, 2025

Army Test and Evaluation Command, Aberdeen Proving Grounds, Mar. 23, 2026
...
\begin{flushleft}
\textbf{Professor of Data Science (Center for Strategic Leadership)} \hfill \textbf{July 2028} - \textbf{Present} \linebreak
The US Army War College, Carlisle Barracks, PA.
\end{flushleft}
Responsibilities include AI-focussed research, assisting faculty in integrating data science into curricula, developing faculty skills through targeted training, and enhancing student data literacy to support senior-level decision-making, while serving as an expert in data analytics, AI, and business intelligence.

\begin{flushleft}
\textbf{Associate Professor (Translational Molecular Pathology, Neurosurgery)} \hfill \textbf{Feb 2020} - \textbf{July 2028} \linebreak
University of Texas MD Anderson Cancer Center, Houston, TX
\end{flushleft}
a) Systems biology architecture for glioma using GLioma AnalySiS (GLASS) consortium data. Constructed an integrative platform using graph database framework for hypothesis generation using Neo4j.
b) Directed the computational pathology program. Spatial point process modeling of cancer tissue images obtained using multiplex immunofluorescence and CODEX technologies.
...
b) Software and pipeline development. Statistical and mathematical modeling.
