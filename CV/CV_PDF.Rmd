...
1. Jason Huse, Bissan Al-Lazikani, Molecular drivers of recurrence in malignant glioma, Cancer Moonshot, UT MD Anderson Cancer Center
...
[31] Prahlad Bhat, Michael Hwang, Afrooz Jahedi, Kanishka Sircar, and \textbf{\textcolor{blue} {Kasthuri Kannan}}. Spatial Point Process Model Predicts Survival in Clear Cell Renal Cell Carcinoma. \textbf{\textit{\textcolor{violet}{medRXiv}}} (doi: https://doi.org/10.1101/2022.02.16.22271019).

\textbf{\textcolor{purple}{Publications/Preprints \textcolor{blue}{(blue - equal contribution/senior/last/first author)}}}

[31] Tathiane M Malta, et al. (with GLASS Consortium), The epigenetic evolution of gliomas is determined by their IDH1 mutation status and correlates to treatment regimens. \textbf{\textit{\textcolor{violet}{Cancer Research (accepted)}}}.

[30] Edwin Parra, Jiexin Jiang et al. {with Cara Haymaker} Multi-omics profiling of lung squamous cell carcinoma reveals immune signatures associated with checkpoint blockade response and resistance. \textbf{\textit{\textcolor{violet}{Clinical Cancer Research (accepted)}}}.
