...
[Data Science 09 - Advanced modeling](https://kannan-kasthuri.github.io/Informatics/DS09/DS09.html): If you have two continous variables that are correlated to a good degree, you may want to apply linear regression. What if you have categorical variables? Logistic regression is a powerful technique to solve some of these problems. In this chapter, we go into the nuts and bolts of how these algorithms work. We review "behind the scenes" method of maximum likelihood and principles of convex optimization. We see how stochastic gradient descent may help working with big data problems. This is slightly mathematically sophesticated, but all efforts are made to make it accessible to general audience.
