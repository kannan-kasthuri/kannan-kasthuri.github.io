...
<span style="color:purple"> _**How about making a scientist tipsy with beer until they tells us stories on the facts they like?**_ </span>
...
<figure style="float:right;">
  <img alt="Zachary Mack" src="Zach.jpg" height = 120; width = 100; hspace="10" />
  <figcaption> Zachary Mack </figcaption>
</figure>

We plan to invite top-notch scientists from a diversity of fields to give a talk at the bar on any subject they choose. After the talk a question-answer session is planned. Thereafter, the audience are welcome to mingle with the scientist to get to know them and their work better. 

We aim to achieve a linear relationship between the number of beers consumed and fascinating information learned! The admission if free although a (free) invitation which can be printed from the internet may be required. Depending on the availability, a debate between scientists are also on the works.

##### When and Where? 

<span style="color:blue"> **First Sunday** </span> of each month between 7 pm-9 pm @ Alphabet City Beer Co. located at 96 Avenue C, New York, NY 10009. Zachary Mack, a beer lover and owner of Alphabet City Beer Co. was considerate enough to accomodate us in one of the [best bars](https://www.thrillist.com/drink/new-york/best-bars-nyc) in the city.

The first (and inauguration) program is planned on Dec. 03, 2017. Click [here](https://kannan-kasthuri.github.io/Outreach/dec_03.html) to know more about the event and the speaker. You may also want to subscribe to the Facebook page "Beer with a Scientist Sundays" and join the [meetup group](https://www.meetup.com/Beer-with-a-Scientist-Sundays/).
